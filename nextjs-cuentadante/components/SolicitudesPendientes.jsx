...
import { Search, FileText, AlertCircle, CheckCircle, XCircle, Calendar, User, Building, Package, Tag, FileCheck, X } from 'lucide-react'
...
const SolicitudesPendientes = () => {
  ...
  const handleApprove = async () => {
    ...
    try {
      const response = await fetch(`/api/requests/${selectedSolicitud.id}/approve`, {
        method: 'PUT',
        headers: {
  ...
  const handleReject = async () => {
    ...
    try {
      const response = await fetch(`/api/requests/${selectedSolicitud.id}/reject`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
